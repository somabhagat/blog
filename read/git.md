...
If you have updated the JSON settings and Antigravity _still_ doesn't see Git, you must tell Windows itself to broadcast the location of the Q: drive tools.
...
`git add .`
_(The dot means "everything in this folder".)_
